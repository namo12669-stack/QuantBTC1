...
def test_complete_synthetic_pipeline_never_certifies(tmp_path,cfg):
    cfg['data'].update(start='2024-09-01',validation_start='2025-01-01',test_start='2025-02-01',end_exclusive='2025-04-01',peers=['ETHUSDT'])
    ...
    model=research(cfg,{'BTCUSDT':b,'ETHUSDT':p},{'BTCUSDT':funding(b),'ETHUSDT':funding(p)},tmp_path,source='synthetic')
